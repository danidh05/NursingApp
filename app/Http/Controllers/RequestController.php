...
class RequestController extends Controller
{
     ...
     *                 @OA\Property(property="duration_hours", type="integer", example=12, nullable=true, description="Nullable. Allowed: 4,6,8,12,24. Note: 24-hour shifts use separate price_24_hours field (not day/night specific, is_day_shift is ignored). Frontend decides what to send based on subcategory."),
     *                 @OA\Property(property="is_continuous_care", type="string", example="false", nullable=true, enum={"true","false","0","1"}, description="Nullable. Category 7 (Duties): Continuous care (1 month). Frontend decides what to send based on subcategory."),
     ...
     *                     @OA\Property(property="duration_hours", type="integer", example=12, nullable=true, description="Nullable. Frontend decides what to send based on subcategory."),
     *                     @OA\Property(property="is_continuous_care", type="boolean", example=false, nullable=true, description="Nullable. Frontend decides what to send based on subcategory."),
