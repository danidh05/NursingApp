...
<body>
    <div class="container">
        ...
        <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
            ...
            help of
            the
            <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank">Free Privacy
                Policy
                Generator</a>.
        </p>
        ...
        <ul>
            ...
            <li>
                <p><strong>Application</strong> refers to Al Ahmad NurseCare, the software program provided by the
                    Company.
                </p>
            </li>
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot;
                    or
                    &quot;Our&quot; in this Agreement) refers to Devzur, Lebanon.</p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: info@alahmadnursecare.com</li>
        </ul>

        <!-- Footer with Contact Info -->
        <p class="contact-info">Thank you for trusting Al Ahmad NurseCare.</p>
    </div>
</body>
